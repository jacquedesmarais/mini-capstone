User.create!([
  {name: "little_fish", email: "tiny_friend@gmail.com", password: "sue", password_confirmation: "sue" admin: false},
  {name: "fish", email: "fish@fish.com", password: "joe", password_confirmation: "joe", admin: true}
])
...
Product.create!([
  {name: "Beluga Whale", price: "7000000.0", description: "playful, giant puppies, tricks", stock: nil, supplier_id: 2, amount: nil},
  {name: "Goldfish", price: "1.0", description: "gold, cheap, multicolored", stock: nil, supplier_id: 2, amount: nil},
  {name: "Anchovies", price: "2.0", description: "delicious", stock: nil, supplier_id: 3, amount: nil},
  {name: "Whale Shark", price: "92000000.0", description: "giant, calm, bottom-feeder", stock: nil, supplier_id: 2, amount: nil},
  {name: "Sea Turtle", price: "34710.0", description: "Green, dude", stock: nil, supplier_id: 1, amount: nil},
  {name: "Jellyfish", price: "4310.0", description: "squishy, soft, hurty", stock: nil, supplier_id: 3, amount: nil},
  {name: "Octopus", price: "4000.99", description: "sucky, scary, very bottom of the ocean", stock: nil, supplier_id: 2, amount: nil},
  {name: "Blue Tang", price: "700.9", description: "blue, flat, fast", stock: nil, supplier_id: 3, amount: nil},
  {name: "Seahorse", price: "30.0", description: "orange, small, cute", stock: nil, supplier_id: 2, amount: 5}
])
...
Image.create!([
  ...
  {product_id: 1, url: "http://www.worldatlas.com/r/w728-h425-c728x425/upload/33/f8/84/shutterstock-140264863.jpg"}
])
